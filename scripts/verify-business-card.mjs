...
const requiredChecks = [
  ...
  [page.includes("backgroundUrl: '/business-card-backgrounds/police.png'"),
    'police theme must use the police front background'],
  [page.includes("backgroundUrl: '/business-card-backgrounds/firefighter.png'"),
    'firefighter theme must use the firefighter front background'],
  [page.includes("backgroundUrl: '/business-card-backgrounds/soccer.png'"),
    'soccer theme must use the soccer front background'],
  [page.includes("backgroundUrl: '/business-card-backgrounds/director.png'"),
    'director theme must use the director front background'],
  [page.includes("backgroundUrl: '/business-card-backgrounds/teacher.png'"),
    'teacher theme must use the teacher front background'],
  [page.includes('card-front-background'), 'front card must render a baked background image'],
  [page.includes('card-front-name-layer'), 'front card must render an editable name layer'],
  [page.includes('card-front-english-name'), 'front card must render an editable English name layer'],
  [page.includes('card-front-brand-mark'), 'front card must render the Wekid logo mark'],
  [page.includes('card-front-brand-lockup'), 'police card must render the reference Wekid Dream Card brand lockup'],
  ...
  [css.includes('.card-front-name-layer'), 'CSS must position the editable front name layer'],
  [css.includes('.card-front-brand-mark'), 'CSS must position the front Wekid logo mark'],
  [css.includes('.card-front-brand-lockup'), 'CSS must position the police reference brand lockup'],
